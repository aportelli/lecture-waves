...
\begin{theorem}[Parseval]
  ...
  \begin{align}
    \braket{P,Q}&=\frac{\tau}{2}\left\{\frac{a_0(a_0')^*}{4}+
    \sum_{n=1}^{M}[a_n(a'_n)^*+b_n(b'_n)^*]\right\}=\tau\sum_{n=-M}^Mc_n(c'_n)^*\,,
    \label{eq:trigp-dot}\\
    \|P\|^2&=\frac{\tau}{2}\left[\frac{|a_0|^2}{4}+\sum_{n=1}^{N}(|a_n|^2+|b_n|^2)\right]
    =\tau\sum_{n=-N}^N|c_n|^2\,,
    \label{eq:trigp-norm}
  \end{align}
  where $M=\min(N,N')$.
