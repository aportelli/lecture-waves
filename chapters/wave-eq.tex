...
general solution of the wave equation can be written
\begin{equation}
  u(t,x)=f(x-ct)+f(x+ct)\,,\label{eq:uff}
\end{equation}
where the constant $K$ has been absorbed in the definition of $f$.
In particular the initial position of the string is
\begin{equation}
  u_0(x)=2f(x)\,.\label{eq:u0K}
\end{equation}
...
generally have a strong influence on the set of solutions. \cref{eq:u0K} determines
