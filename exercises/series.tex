...
\begin{ExerciseList}
  ...
  \Question Compute the Fourier coefficients of the functions below. All functions are
  assumed periodic, and the given interval represents one period.
  ...
  \end{equation}
  %---------------------------------------------------------------------------------------
  \Exercise[label=fourierode2] Let $f$ be a real twice and continuously differentiable
  function on $\R$ which is a solution of the ordinary differential equation
  \begin{equation}
